...
3. Построить признаки:
   ...
   - time features из source timestamp: hour, minute, halfhour_slot, dayofweek, is_weekend, sin/cos по slot и dayofweek
   - future calendar features отдельно для каждого горизонта h=1..10 из target_timestamp = timestamp + 30min*h
   - лаги target_2h по route_id: 1,2,3,4,6,8,12,24,48,96,336
   - rolling mean/std/min/max target_2h по route_id с использованием только прошлого через shift(1)
